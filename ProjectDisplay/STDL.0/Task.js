...
function renderTasks() {
  ...
  tasksArr.forEach((task) => {
    ...
    tasksWrapper.innerHTML += `
          ...
          <div class="left">
            <div class="radio">
              <ion-icon class="icon" name="checkmark" style="margin-top: 0px;"></ion-icon>
            </div>
          </div>
          <div class="right">
            ...
            <div class="info ${expired}">
              <p class="date">
                <ion-icon name="calendar-outline" style="margin-top: 0px;"></ion-icon>
                <span>${task.date}</span>
              </p>
              <p class="dot">
                <ion-icon name="ellipse" style="margin-top: 0px;"></ion-icon>
              </p>
              <p class="time">
                <ion-icon name="time-outline" style="margin-top: 0px;"></ion-icon>
                <span>${task.time}</span>
              </p>
            </div>
          </div>
  ...
  tasksWrapper.innerHTML += `
     <div class="delete">
          <ion-icon name="trash-outline" style="margin-top: 0px;"></ion-icon>
        </div>`;
