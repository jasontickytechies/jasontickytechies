...
function updateEvents(date) {
    ...
    // eventsContainer.innerHTML = events;(FIX)
    saveEvents();
}

addEventSubmit.addEventListner("click", () => {
    const eventTitle = addEventTitle.value;
    const eventTimefrom = addEventFrom.value;
    const eventeventTimeToTimeFrom = addEventTo.value;

    if(eventTitle === "" || eventTimeFrom === "" || eventTimeFromTimeFrom === ""){
...
function convertTime(time){
    ...
    let timeHour = time.Arr[0];
    let timeMin = time.Arr[1];
